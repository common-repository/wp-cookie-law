...
function wpcookielaw_register_custom_post_type() {
	$labels = array(
		'name'					=> _x('WP Cookie Law', 'post type general name'),
	...
	register_post_type( 'wpcookielaw' , $args );
}
 ...
 */
function wpcookielaw_custom_posts_admin_init() {
	add_meta_box("_cli_cookie_type", "Cookie Type", "wpcookielaw_cookie_type", "wpcookielaw", "side", "default");
	add_meta_box("_cli_cookie_duration", "Cookie Duration", "wpcookielaw_cookie_duration", "wpcookielaw", "side", "default");
}


/** Display the custom meta box for cookie_type */
function wpcookielaw_cookie_type() {
	global $post;
...
function wpcookielaw_cookie_duration() {
	global $post;
	$custom = get_post_custom( $post->ID );
...
function wpcookielaw_save_custom_metaboxes() {
	global $post;
...
function wpcookielaw_edit_columns( $columns ) {
	$columns = array(
...
function wpcookielaw_custom_columns( $column ) {
	global $post;
